...
//******************************************
    ...
    rx.setPattern(".*"+current.Name+".{1,4}[Ss]{0,1}("+current.Season+"|"+QString("%1").arg(current.Season.toInt())+")[EexX]"+current.Episode+".*torrent");
    //*********************************************************************************
